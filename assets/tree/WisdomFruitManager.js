...
export class WisdomFruitManager {
  ...
  setParentAnchor(anchor) {
    if (!anchor || this.treeAnchor === anchor) return;
    if (this.treeAnchor && this.fruitGroup) {
      this.treeAnchor.remove(this.fruitGroup);
    }
  ...
  syncWithTreeGeometry() {
    ...
    const currentTree = this.treeManager?.tree || (this.treeManager?.teamTrees && this.treeManager.teamTrees[(this.treeManager.activeTeamId || 1) - 1]);
